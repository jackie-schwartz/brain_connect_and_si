...
### filepaths
```{r, echo=FALSE,results='hide', message=FALSE}
degree_fp <- "~/Box/deg_aucs.csv"
effic_loc_fp <- "~/Box/eff_loc_aucs.csv"
eig_cent_fp <- "~/Box/eig_cent_aucs.csv"
part_coeff_fp <- "~/Box/pc_aucs.csv"
within_mod_zscore_fp <- "~/Box/wm_z_aucs.csv"
```
...
## write csv
```{r}
graph_all_fp <- "~/Box/graph_all.csv"
write_csv(graph_all, graph_all_fp)
```
