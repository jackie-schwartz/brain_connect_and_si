...
# reading data
```{r message=FALSE}
eff_loc_fp <- "~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/Octo2020Analysis/results/eff_loc.xlsx"
eff_loc_th.1 <-
...
### write csv
```{r}
eff_loc_aucs_select_fp <-"~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/Octo2020Analysis/eff_loc_aucs.csv"
