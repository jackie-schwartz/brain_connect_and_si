...
Computes AUC for within module z score (not normalized)
...
# reading data
```{r}
wm_z_fp <- "~/Box/within_mod_z_score.xlsx"
wm_z_th.1 <-
  read_excel(wm_z_fp, sheet = "deg_z_.1")
wm_z_th.12 <-
  read_excel(wm_z_fp, sheet = "deg_z_.12")
wm_z_th.14 <-
  read_excel(wm_z_fp, sheet = "deg_z_.14")
wm_z_th.16 <-
  read_excel(wm_z_fp, sheet = "deg_z_.16")
wm_z_th.18 <-
  read_excel(wm_z_fp, sheet = "deg_z_.18")
wm_z_th.2 <-
  read_excel(wm_z_fp, sheet = "deg_z_.2")
```
...
### write csv
```{r}
wm_z_aucs_select_fp <-"~/Box/wm_z_aucs.csv"
