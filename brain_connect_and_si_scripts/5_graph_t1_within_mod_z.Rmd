...
Computes AUC for within-module degree (not normalized)
...
# reading data
```{r message=FALSE}
wm_z_fp <- "~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/April2021Analysis/within_mod_z_score.xlsx"
wm_z_th.1 <-
...
### write csv
```{r}
wm_z_aucs_select_fp <-"~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/April2021Analysis/wm_z_aucs.csv"
