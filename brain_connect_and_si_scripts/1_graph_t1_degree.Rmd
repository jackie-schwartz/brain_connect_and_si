...
# reading data
```{r message=FALSE}
deg_fp <- "~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/Octo2020Analysis/results/deg.xlsx"
deg_th.1 <-
...
### write csv
```{r}
deg_aucs_select_fp <-"~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/PHIND_RS_and_Suicide/Octo2020Analysis/deg_aucs.csv"
